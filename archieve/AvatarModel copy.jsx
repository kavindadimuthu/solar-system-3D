...
const Avatar = ({ texturePath }) => {
  ...
  const texture = useTexture("https://drive.google.com/uc?export=download&id=1NnH-qctyqusjGPyDoqpXyrMFppYDlE5w"); // Load texture based on user selection
...
const AvatarModel = () => {
  // const [selectedTexture, setSelectedTexture] = useState("https://drive.google.com/uc?export=download&id=1NnH-qctyqusjGPyDoqpXyrMFppYDlE5w"); // Default texture
